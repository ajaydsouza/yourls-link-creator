		...
		<div id="yourls-admin-about" class="postbox yourls-sidebox">
			...
			<div class="inside">
				...
				<p><strong><?php _e( 'Questions?', 'wpyourls' ); ?></strong><br />
					...
					<?php echo sprintf( __( 'Talk to <a href="%1$s" class="external">@norcross</a> on twitter or visit the <a href="%2$s" class="external">plugin support forum</a> for bugs or feature requests.', 'wpyourls' ), esc_url( 'https://twitter.com/norcross' ), esc_url( 'https://wordpress.org/support/plugin/yourls-link-creator/' ) ); ?></p>
